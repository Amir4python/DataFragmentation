...
<body>
  ...
  <div class="container">
    <div class="jumbotron">
      ...
      <h3>Covid vaccine Based On CITY WISE</h3>
        <div class="card-body">

          <?php
                    $connection=mysqli_connect("localhost","root","");
                    $db=mysqli_select_db($connection,'myadbms');
                    $query1="SELECT * FROM vaccine where city='Belagavi'";
                    $queryrun1=mysqli_query($connection,$query1);
                    $query2="SELECT * FROM vaccine where city='Mysore'";
                    $queryrun2=mysqli_query($connection,$query2);
                    $query3="SELECT * FROM vaccine where city='Bangalore'";
